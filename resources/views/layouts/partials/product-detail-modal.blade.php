        ...
        <div class="flex items-center justify-center min-h-screen p-2 sm:p-3 md:p-4">
            ...
            <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[92vh] overflow-hidden mx-auto">
                @if ($post)
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-baseline gap-3">
                                    ...
                                    @if($product && $product->cost_price)
                                        <span class="text-sm text-gray-400 line-through">${{ number_format($product->cost_price, 2) }}</span>
                                    @endif
                                </div>
                    ...
                    @include('layouts.partials.variant-gallery-modal', ['variantImages' => $variantImages, 'variants' => $variants, 'product' => $product, 'service' => null])
                @else

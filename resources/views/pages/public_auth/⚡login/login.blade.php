<div>
  <div>
    ...
    <section class="relative overflow-hidden py-8 sm:py-12 lg:py-16">
      ...
      <div class="relative z-10 w-full max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-10">
        ...
        <div class="flex flex-col lg:flex-row items-center justify-center gap-6 sm:gap-8 lg:gap-12">
          ...
          <div class="hidden lg:block w-full lg:w-auto lg:max-w-md shrink-0 lg:order-1">
            ...
            <div class="mt-7 flex items-center gap-4">
              ...
              <a href="#" class="text-gray-500 hover:text-emerald-700 transition-colors" aria-label="Instagram">
              ...
              <a href="#" class="text-gray-500 hover:text-emerald-700 transition-colors" aria-label="Facebook">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="#" class="text-gray-500 hover:text-emerald-700 transition-colors" aria-label="Twitter">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">

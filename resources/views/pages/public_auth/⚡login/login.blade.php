<div>
  <div>
    ...
    <section class="relative overflow-hidden lg:h-[calc(100vh-88px)] flex items-center justify-center bg-[#FDF6F9] py-4 sm:py-6">
      ...
      <div class="relative z-10 w-full max-w-[1700px] mx-auto px-3 sm:px-6 lg:px-10">
        ...
        <div class="flex flex-col lg:flex-row items-center justify-center gap-4 sm:gap-6 lg:gap-10">
          ...
          <div class="w-full sm:w-auto shrink-0 lg:order-2">
            <div class="bg-white w-full sm:w-[400px] lg:w-[400px] rounded-xl sm:rounded-lg shadow-xl shadow-[#D6657A]/10 border border-[#F4D9E2] p-5 sm:p-6">
...
<div class="flex flex-col items-center justify-center gap-1 mb-6">
  ...
  <p class="text-[9px] text-[#D6657A]/40 tracking-[0.2em] uppercase font-light leading-none">Luxury Salon</p>
              ...
              {{-- Session error --}}
              @if(session('error'))
                <div class="mb-3 p-2 rounded-lg bg-[#F4D9E2] border border-[#D6657A]/30 text-[#D6657A] text-xs">
                  {{ session('error') }}
                </div>
              @endif
              ...
              <form wire:submit.prevent="login" class="space-y-3">
                ...
                <div class="relative">
                  ...
                  <button type="button" onclick="togglePassword()" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#D6657A]">
              ...
              <p class="text-center text-xs text-[#D6657A]/70 mt-4">
                ...
                <a href="{{ route('register.page') }}" class="text-[#D6657A] font-medium hover:underline">Sign Up</a>
              </p>

              <!-- Social Login Buttons - 2 Column Row -->
              <div class="flex gap-2 mt-3">
                <!-- Facebook Login -->
                <button type="button" class="flex-1 flex items-center justify-center gap-2 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-medium py-2 rounded text-xs transition">
                  <svg class="w-4 h-4 shrink-0 text-[#1877F2]" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div class="hidden lg:block w-full lg:w-auto lg:max-w-md shrink-0 lg:order-1">
            ...
            <p class="mt-4 text-base text-[#D6657A]/80 leading-relaxed">
              Discover top-rated salons and premium beauty products. Book instantly and transform your style.
            </p>
            <ul class="mt-4 space-y-2.5 text-base text-[#D6657A]/90">
              <li class="flex items-center gap-3">
                <svg class="w-5 h-5 text-[#D6657A] shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">

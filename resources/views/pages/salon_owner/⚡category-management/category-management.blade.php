                        ...
                        <table class="w-full">
                            <thead class="bg-gray-100 border-b border-gray-200">
                                <tr>
                                    ...
                                    <th class="px-5 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Category Name</th>
                            ...
                            <tbody class="divide-y divide-gray-100">
                                @foreach($categories as $index => $category)
                                    <tr class="hover:bg-white transition">
                                        ...
                                        <td class="px-5 py-3 text-sm text-gray-500">{{ $category->created_at->format('M d, Y') }}</td>
